...
static func entries[32]= {
        ...
        ajax_mgr_down,   // { 6, "down",    "Start 15 seconds countdown",      ""},
        ajax_mgr_fault,  // { 7, "fault",   "Mark fault (+/-/#)",              "< + | - | num >"},
        ajax_mgr_refusal,// { 8, "refusal", "Mark refusal (+/-/#)",            "< + | - | num >"},
        ajax_mgr_elim,   // { 9, "elim",    "Mark elimination [+-]",           "[ + | - ] {+}"},
        ajax_mgr_reset,  // { 10, "reset",  "Reset chronometer and countdown", "" },
        NULL,            // { 11, "help",   "show command list",               "[cmd]"},
        NULL,            // { 12, "version","Show software version",           "" },
        ajax_mgr_exit,   // { 13, "exit",   "End program (from console)",      "" },
        ajax_mgr_server, // { 14, "server", "Set server IP address",           "<x.y.z.t> {0.0.0.0}" },
